-- Znote AAC schema (compatível com ot-login-api / sites Znote).
-- Fonte: https://github.com/Znote/ZnoteAAC/blob/master/engine/database/znote_schema.sql
-- Corre após 01-schema.sql (Canary): cria tabelas znote_* e sincroniza contas/jogadores existentes.
